...
const Contact2 = () => {
	...
	return (
		<section
			className="w-full md:px-12 px-6 py-24"
			style={sectionStyle}
			id="contact">
			<div className="grid md:grid-cols-2 ">
				...
				<div className="order-2  text-sm font-bold flex flex-col justify-center items-center rounded-xl relative">
					...
					<button
						className="overflow rounded-md mt-4 bg-white group relative overflow-hidden text-[12px]  text-black px-4 py-2 before:absolute before:top-full before:left-0 before:h-full before:w-full before:bg-black before:transition-transform before:duration-500 hover:before:-translate-y-full"
						onClick={toggleForm1}>
